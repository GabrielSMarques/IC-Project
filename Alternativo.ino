...
void mover(char side, int tempo){
  switch(side){
    case 'd': moverMotor('d', -40);
              moverMotor('e', 40);
              break;

    case 'e': moverMotor('d', 40);
              moverMotor('e', -40);
              break;   

    case 'f': moverMotor('d', 40);
              moverMotor('e', 40);
              break;             
  }
...
void seguidorDeLinha(){
  static int estado=0, velOutLine1=0, velOutLine2=55, velInLine1=0, velInLine2=35;
